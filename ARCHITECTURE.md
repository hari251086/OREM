...
**Open, priority order**: **#32** (P1, critical — standing umbrella tracking issue for the RPE-accuracy investigation; kept open by explicit user decision even though every phase and every child issue is currently closed); and the P4 operational backlog (#17). #28 closed 2026-08-01 (gfortran now builds and passes 100%, CI matrix added); #24 closed 2026-08-01 (relocated to `OREM-Watchlist`#12, its real dependencies live there). **385 tests across 12 suites**.
