...
**Open, priority order**: **#32** (P1, critical — standing umbrella tracking issue for the RPE-accuracy investigation; kept open by explicit user decision even though every phase and every child issue is currently closed); #28 (P4 — `propagate_ks.F` doesn't compile under gfortran); and the P4 operational backlog (#17, #24). **385 tests across 12 suites**.
