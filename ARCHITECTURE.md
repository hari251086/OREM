...
Across the curated-7 validation set, **static atmosphere**: mean\|latest-zone RPE\| **25.9%**, mean\|ensemble RPE\| **1.9%** (median 1.2%) — see the real per-object table in §6. **With epoch-resolved weather + the diurnal bulge** (§4.1): mean\|latest-zone RPE\| **27.4%**, mean\|ensemble RPE\| **1.9%** (median 0.4%). Across the full 50-object generalization set (§7): mean\|ensemble RPE\| **16.8%**, predict rate **36/50 (72%)**.
